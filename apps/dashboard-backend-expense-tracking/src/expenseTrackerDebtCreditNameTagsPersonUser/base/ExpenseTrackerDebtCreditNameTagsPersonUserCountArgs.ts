...
@ArgsType()
class ExpenseTrackerDebtCreditNameTagsPersonUserCountArgs {
  @ApiProperty({
    required: false,
...
export { ExpenseTrackerDebtCreditNameTagsPersonUserCountArgs as ExpenseTrackerDebtCreditNameTagsPersonUserCountArgs };
